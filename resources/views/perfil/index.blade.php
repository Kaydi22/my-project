...
@section('contenido')
     <div class="md:flex md:justify-center">
        <div class="md:w-1/2 bg-white shadow p-6">
            <form method="POST" action="{{ route('perfil.store', auth()->id()) }}" enctype="multipart/form-data" class="mt-10 md:mt-0">
                ...
                <input 
                   ...
                   class="bg-sky-600 hover:bg-sky-700 transitions-colors cursor-pointer uppercase
